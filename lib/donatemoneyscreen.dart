            ...
            children: [
                ...
                child: InkWell(
                  child: const Text('Donate Goods ',
                      style: TextStyle(
                          ...
                          onTap: (){
                            Navigator.push(
                          context,MaterialPageRoute(builder: (context) => const DonateGoodsScreen()));
                          },
                ),
              ),        
                ],
              ...
              Row(
                children: [
                  ...
                  paymentMethod=='debit_card'?  Container(
                    height: 520,
                    width:  350,
                  ...
                  child:  Center(
                      child: InkWell(
                        ...
                        builder: (context) {
                          return Container(
                              child: AlertDialog(
                            title: const Text('Transaction has been done successfully!'),
                            actions: [
                              TextButton(
                                  onPressed: () {
                                    Navigator.push(
                    ...
                    child:Column(
                      ...
                      children:  [
                        const Padding(
                          ...
                          child: Text('Bank Name:',style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold,fontSize: 20),),
                        ),
                        const SizedBox(height: 10),
                        const Padding(
                        ...
                        const Padding(
                          padding: EdgeInsets.only(left: 8.0, top:10),
                          child: Text('Account Number:',style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold,fontSize: 20),),
                        ),
                        const SizedBox(height: 10),
                        const Padding(
                          padding: EdgeInsets.only(left: 125.0),
                        ...
                        const Padding(
                          padding: EdgeInsets.only(left: 8.0, top:10),
                          child: Text('Account Title:',style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold,fontSize: 20),),
                        ),
                        const SizedBox(height: 10),
                        const Padding(
                          padding: EdgeInsets.only(left: 125.0),
